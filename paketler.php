        ...
        <div class="content-body">
            <section id="pricing-plan">
                <div class="text-center">
                    <h1 class="mt-2">Jargon Checker Üyelik Paketleri</h1>
                    <p class="mb-2 pb-50">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2">
                                                <span class="pricing-basic-value fw-bolder text-primary">50</span>
                            ...
                            <div class="col-12 col-md-4">
                                <div class="card enterprise-pricing text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="annual-plan">
                                            <div class="plan-price mt-2">
                                                <span class="pricing-enterprise-value fw-bolder text-primary">200/250</span>
                                                <sup class="font-medium-1 fw-bold text-primary">₺</sup>
                                                <sub class="pricing-duration text-body font-medium-1 fw-bold">Yıllık/Sınırsız</sub>
                                            </div>
                                            <small class="annual-pricing d-none text-muted"></small>
                                        </div>
                            ...
                            <div class="accordion accordion-margin" id="accordionExample">
                                <div class="card accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            ...
                                            Fakat <a href="https://discord.gg/aB3vp73KDh" target="_blank">Discord</a> sunucumuza gelip bizlere ulaşarak, böyle bir ödeme yöntemini
                                ...
                                <div class="card accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Böyle bir şey ne yazık ki söz konusu değildir. Jargon Checker yetkilisi olduğunu iddia eden kişilerle iletişim kurmayınız, sadece web sitemiz üzerinden destek alınız.
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    {
        window.location = 'https://discord.gg/aB3vp73KDh';
        return false;
    }
</script>
